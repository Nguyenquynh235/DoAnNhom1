...
session_start();
include 'ket_noi.php';
$danh_sach = $conn->query("SELECT * FROM phong WHERE loai_nhom = 'lon'");
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    <meta charset="UTF-8">
    <title>Phòng Nhóm Lớn</title>
...
<div class="main">
    <h2>📁 DANH SÁCH PHÒNG NHÓM LỚN (20–30 NGƯỜI)</h2>
    <div class="row">
